...
class MIRBodyEmitter {
    ...
    emitInvokeVirtualTarget(sinfo: SourceInfo, rtkey: MIRResolvedTypeKey, vresolve: MIRVirtualMethodKey, args: MIRArgument[], refs: [string, MIRResolvedTypeKey][], trgt: MIRTempRegister) {
        if (refs.length === 0) {
