...
class MIREmitter {
    ...
    emitLoadConstDecimal(sinfo: SourceInfo, iv: string, trgt: MIRTempRegister) {
        ...
        this.m_currentBlock.push(new MIRLoadConst(sinfo, new MIRConstantDecimal(iv), trgt));
    }
