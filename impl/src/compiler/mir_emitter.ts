...
class MIREmitter {
    ...
    emitInvokeFixedFunction(sinfo: SourceInfo, ikey: MIRInvokeKey, args: MIRArgument[], optstatusmask: string | undefined, retinfo: [MIRType, MIRType, number, [string, MIRType][]], trgt: MIRTempRegister) {
        if(!this.emitEnabled) {
            return;
        }
