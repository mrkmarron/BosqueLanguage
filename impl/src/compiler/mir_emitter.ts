...
class MIREmitter {
    ...
    emitVerifierAssume(sinfo: SourceInfo, src: MIRArgument) {
        if(!this.emitEnabled) {
            return;
        }

        this.m_currentBlock.push(new MIRVerifierAssume(sinfo, src));
    }
